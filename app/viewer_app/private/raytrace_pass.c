...
static void raytrace_setup_pass ( const xf_node_execute_args_t* node_args, void* user_args ) {
    ...
    xg_buffer_range_t instance_buffer_range = xg->write_workload_staging ( node_args->workload, instance_data, instance_data_size, 1 );
    ...
    xg_buffer_range_t light_buffer_range = xg->write_workload_staging ( node_args->workload, light_data, light_data_size, 1 );
