...
// to change reverse_z setting: viewapp_state, common.glsl, depth_write_dxx instead of depth_write_reverse_dxx in .xsg files 
//      TODO automate this to only one place/setting
#define viewapp_main_view_reverse_z_m true
