...
xg_sampler_h xg_sampler_create ( const xg_sampler_params_t* params ) {
    ...
    xg_sampler_h handle = ( xg_sampler_h ) ( sampler - xg_vk_sampler_state->samplers_array );
    return handle;
}
...
static xg_sampler_h xg_sampler_create_default ( xg_device_h device, xg_default_sampler_e sampler_enum ) {
    ...
    params.enable_anisotropy = false;
    params.min_mip = 0;
    params.max_mip = xg_texture_all_mips_m;
    params.mip_bias = 0;
    ...
    switch ( sampler_enum ) {
        case xg_default_sampler_point_clamp_m:
            ...
            params.debug_name = "xg default sampler point_clamp";
            break;
        ...
        case xg_default_sampler_linear_clamp_m:
            ...
            params.address_mode = xg_sampler_address_mode_clamp_m;
            params.debug_name = "xg default sampler linear_clamp";
            break;
...
bool xg_sampler_get_info ( xg_sampler_h sampler_handle, xg_sampler_info_t* info ) {
    ...
    info->debug_name = sampler->params.debug_name;

    return true;
}

bool xg_sampler_destroy ( xg_sampler_h sampler ) {
    std_unused_m ( sampler );
