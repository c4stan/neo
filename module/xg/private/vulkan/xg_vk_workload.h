...
xg_buffer_range_t xg_workload_write_uniform ( xg_workload_h workload, std_buffer_t buffer );
xg_buffer_range_t xg_workload_write_staging ( xg_workload_h workload, std_buffer_t buffer, size_t align );
