...
xg_resource_bindings_h xg_vk_pipeline_create_resource_bindings ( xg_pipeline_state_h pipeline, xg_shader_binding_set_e set );
...
xg_resource_bindings_layout_h xg_vk_pipeline_create_bindings_layout ( xg_resource_bindings_layout_params_t* params );
