...
layout ( binding = 1, set = xs_resource_binding_set_per_draw_m ) uniform utexture2D tex_atlas;

layout ( binding = 2, set = xs_resource_binding_set_per_draw_m ) uniform sampler sampler_point;
