...
layout ( binding = 0, set = xs_resource_binding_set_per_draw_m ) uniform draw_uniforms_t {
...
layout ( set = xs_resource_binding_set_per_draw_m, binding = 2 ) uniform sampler tex_sampler;
