...
def init(root_path, tool_path, workspace_paths):
    ...
    BINDINGS = bindings.load('tool/bindings')
    if not BINDINGS:
...
def print_help():
    ...
    print('\t' + Color.OKGREEN + 'create' + Color.OKBLUE + ' <name>' + Color.ENDC + ' to create a new workspace')
